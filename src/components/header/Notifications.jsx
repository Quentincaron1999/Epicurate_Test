          ...
          <ul>
            <li className="border-b border-slate-200 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">📣 <span className="font-medium text-slate-800">New Reservation</span> Sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim.</span>
            ...
            <li className="border-b border-slate-200 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">🚀<span className="font-medium text-slate-800">Reservation Canceled</span> Sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim.</span>
