        ...
        <div>
          ...
          <ul className="my-1">
            <li className="flex px-2">
              ...
              <div className="grow flex items-center border-b border-slate-100 text-sm py-2">
                <div className="grow flex justify-between">
                  <div className="self-center"><a className="font-medium text-slate-800 hover:text-slate-900" href="#0">Facebook Ad</a> billing</div>
            ...
            <li className="flex px-2">
              ...
              <div className="grow flex items-center border-b border-slate-100 text-sm py-2">
                <div className="grow flex justify-between">
                  <div className="self-center"><a className="font-medium text-slate-800 hover:text-slate-900" href="#0">Google</a> Montainview</div>
                  <div className="shrink-0 self-start ml-2">
            ...
            <li className="flex px-2">
              ...
              <div className="grow flex items-center border-b border-slate-100 text-sm py-2">
                <div className="grow flex justify-between">
                  <div className="self-center"><a className="font-medium text-slate-800 hover:text-slate-900" href="#0">Bambou Tech</a> Cupertino</div>
                  <div className="shrink-0 self-start ml-2">
